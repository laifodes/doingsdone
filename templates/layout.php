...
<footer class="main-footer">
    <div class="container">
        ...
        <a class="main-footer__button button button--plus" href="/add-task.php<?php if (isset($_GET['id'])):?><?= '?id=' . $id ?><?php endif;?>">Добавить задачу</a>
        ...
        ,</span>
            ...
            <a class="social__link social__link--vkontakte" href="https://vk.com/laifodes">
